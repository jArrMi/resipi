...
class SpoonacularRepository(private val localDataSource: Local,
                            private val remoteDataSource: Remote): Repository {

    override fun searchRecipes(apiKey: String, query: String, offset: Int, number: Int): Single<GetRecipesResponse> {
